...
const WhatsAppFloat: React.FC = () => {
  return (
    ...
    >
      ...
      {/* The Button */}
      <div className="bg-eco-accent border border-eco-dark text-eco-dark p-3 md:p-4 shadow-sharp transition-all duration-200 group-hover:translate-x-[2px] group-hover:translate-y-[2px] group-hover:shadow-sharp-hover group-hover:bg-eco-dark group-hover:text-eco-accent flex items-center justify-center relative overflow-hidden">
        
        {/* Noise overlay for texture consistency */}
        <div className="absolute inset-0 opacity-10 bg-noise pointer-events-none"></div>
        
        {/* Custom SVG for WhatsApp to maintain brand recognition while applying site colors */}
        <svg viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6 md:w-8 md:h-8 z-10">
